                        ...
                        perform
                            ...
                            (flip shouldBe $
                             [ Channel.EventMessage 100 500 $
                               Channel.plainText "Sample Text"
                             , Channel.EventMessage 101 501 $
                               Channel.plainText "Sample Text 2"
                             ])
                        perform
                            pexpectations
                            (Channel.poll channel)
                            ...
                            (flip shouldBe $
                             [ Channel.EventMessage 100 505 $
                               Channel.plainText "Sample Text 3"
                             ])
                        perform
                            pexpectations
                            (Channel.poll channel)
                        ...
                        perform
                            ...
                            [ Request
                              ...
                              object
                                  [ "ok" .= True
                                  , "result" .=
                                    object ["message_id" .= (600 :: Int)]
                                  ]
                            ]
                            (flip shouldBe $ Right 600)
                        perform
                            pexpectations
                            (Channel.sendMessage
                                 channel
                                 102
                                 (Channel.plainText "message 2")
                                 [])
                            [ Request
                                  ("https://api.telegram.org/" <>
                                   token <> "/sendMessage")
                    ...
                    Tg.withTgChannel conf logger driver $ \channel -> do
                        perform
                            ...
                            (Channel.updateMessage
                                 ...
                                 100
                                 600
                                 (Channel.plainText "updated message")
                                 [])
                            [ Request
                                  ("https://api.telegram.org/" <>
                    ...
                    Tg.withTgChannel conf logger driver $ \channel -> do
                        perform
                            ...
                            [ Request
                                  ...
                                  [ WebDriver.ParamNum "chat_id" $ 100
                                  , WebDriver.ParamText "text" $ "message"
                                  , WebDriver.ParamJson "reply_markup" $
                                    object
                                        [ "inline_keyboard" .=
                                          [ [ object
                                                  [ "text" .= ("t1" :: Text)
                    ...
                    Tg.withTgChannel conf logger driver $ \channel -> do
                        perform
                            ...
                            [ Request
                                  ...
                                  [ WebDriver.ParamText "callback_query_id" $
                                    "qid1"
                                  , WebDriver.ParamText "text" $ ""
                                  ] |>>
                              object ["ok" .= True, "result" .= True]
                                    ...
                                    [ object
                                          ...
                                          , "message" .=
                                            object
                                                ...
                                                , "text" .=
                                                  ("plain bold italic bolditalic plain under strike understrike boldunder under" :: Text)
                                    ...
                                    [ object
                                          ...
                                          , "message" .=
                                            object
                                                ...
                                                , "text" .=
                                                  ("link bold link plain mention under" :: Text)
                                    ...
                                    [ object
                                          ...
                                          , "message" .=
                                            object
                                                ...
                                                , "text" .=
                                                  ("inline-code plain block-code plain block-code-lang" :: Text)
                                    ...
                                    [ object
                                          ...
                                          , "message" .=
                                            object
                                                ...
                                                {-                       ^     345                ^2 -}
                                                , "text" .=
                                                  ("tt \x1F914\x1F914 bb \x1F914\x1F914 uu tt" :: Text)
