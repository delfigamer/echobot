    ...
    describe "Responder.Repeat" $ do
        ...
        let config =
                Responder.Repeat.Config
                    ...
                    , Responder.Repeat.cInspectMultiplierCmd =
                          inspectMultiplierCmd
                    , Responder.Repeat.cInspectMultiplierMsg =
                          inspectMultiplierMsg "%1"
                    , Responder.Repeat.cMultiplierSetMsg = multiplierSetMsg "%1"
                    , Responder.Repeat.cMediaUnknownTypeMsg =
                          mediaUnknownTypeMsg "%1"
                    , Responder.Repeat.cMediaUnsupportedMsg =
                          mediaUnsupportedMsg
                    , Responder.Repeat.cMediaInternalErrorMsg =
                          mediaInternalErrorMsg
        ...
        let possessMediaSuccess t n =
                Channel.PossessMediaSuccess $ Channel.SendableMedia t n
                    ...
                    Responder.Repeat.withRepeatResponder config logger channel $ \responder -> do
                        oneWork
                            ...
                            [ Channel.EventMessage
                                  105
                                  600
                                  (Channel.plainText "some text")
                            ]
                            [ SendMessage 105 (Channel.plainText "some text") [] |>>
                              Right 603
                            , SendMessage 105 (Channel.plainText "some text") [] |>>
                              Right 604
                            ]
                        oneWork
                            ...
                            [ Channel.EventMessage
                                  100
                                  500
                                  (Channel.plainText "mytext 500")
                            , Channel.EventMessage
                                  100
                                  501
                                  (Channel.plainText "mytext 501")
                            ]
                            [ SendMessage
                                  100
                                  (Channel.plainText "mytext 500")
                    ...
                    Responder.Repeat.withRepeatResponder config logger channel $ \responder -> do
                        oneWork
                            ...
                            [ Channel.EventMessage
                                  105
                                  601
                                  (Channel.plainText "/unknown-command")
                            ]
                            [ SendMessage
                                  105
                                  (Channel.plainText unknownCmdMsg)
                                  [] |>>
                              Right 605
                            ]
                        oneWork
                    ...
                    Responder.Repeat.withRepeatResponder config logger channel $ \responder -> do
                        oneWork
                            ...
                            [ Channel.EventMessage
                                  105
                                  601
                                  (Channel.plainText inspectMultiplierCmd)
                            ]
                            [ SendMessage
                                  105
                                  (Channel.plainText (inspectMultiplierMsg "2"))
                                  inspectButtons |>>
                              Right 605
                            ]
                        oneWork
                            ...
                            , UpdateMessage
                                  105
                                  605
                                  (Channel.plainText (multiplierSetMsg "3"))
                                  [] |>>
                              Right ()
                            ]
                        oneWork
                            ...
                            [ Channel.EventMessage
                                  105
                                  607
                                  (Channel.plainText "message in 105")
                            ]
                            [ SendMessage
                                  105
                                  (Channel.plainText "message in 105")
                    ...
                    Responder.Repeat.withRepeatResponder config logger channel $ \responder -> do
                        ...
                        oneWork
                            ...
                            , UpdateMessage
                                  100
                                  12
                                  (Channel.plainText (multiplierSetMsg "1"))
                                  [] |>>
                              Right ()
                            ...
                            , UpdateMessage
                                  200
                                  22
                                  (Channel.plainText (multiplierSetMsg "2"))
                                  [] |>>
                              Right ()
                            ]
                        oneWork
                            ...
                            [ Channel.EventMessage
                                  200
                                  23
                                  (Channel.plainText "message in 200")
                            , Channel.EventMessage
                                  300
                                  33
                                  (Channel.plainText "message in 300")
                            , Channel.EventMessage
                                  100
                                  13
                                  (Channel.plainText "message in 100")
                            , Channel.EventMessage
                                  500
                                  53
                                  (Channel.plainText "message in 500")
                            ]
                            [ SendMessage
                                  200
                                  (Channel.plainText "message in 200")
                        ...
                        oneWork
                            ...
                            [ SendMessage
                                  100
                                  (Channel.plainText (inspectMultiplierMsg "1"))
                                  inspectButtons |>>
                              Right 101
                            , SendMessage
                                  500
                            ...
                            , SendMessage
                                  300
                                  (Channel.plainText (inspectMultiplierMsg "3"))
                                  inspectButtons |>>
                              Right 101
                            ]
        it "starts itself" $ do
                    ...
                    Responder.Repeat.withRepeatResponder config logger channel $ \responder -> do
                        oneWork
                            ...
                            [ Channel.EventMessage
                                  100
                                  11
                                  (Channel.plainText startCmd)
                            ]
                            [ SendMessage
                                  100
                                  (Channel.plainText (startMsg "2"))
                                  [] |>>
                              Right 12
                            ]
                        oneWork
                    ...
                    Responder.Repeat.withRepeatResponder config logger channel $ \responder -> do
                        oneWork
                            ...
                            [ Channel.EventMessage
                                  100
                                  11
                                  (Channel.plainText describeCmd)
                            ]
                            [ SendMessage
                                  100
                                  (Channel.plainText (describeMsg "2"))
                                  [] |>>
                              Right 12
                            ]
                        oneWork
                        ...
                        oneWork
                            ...
                            , UpdateMessage
                                  100
                                  14
                                  (Channel.plainText (multiplierSetMsg "4"))
                                  [] |>>
                              Right ()
                            ]
                        oneWork
                            ...
                            [ SendMessage
                                  100
                                  (Channel.plainText (describeMsg "4"))
                                  [] |>>
                              Right 16
                            ]
        it "repeats media" $ do
                    ...
                    Responder.Repeat.withRepeatResponder config logger channel $ \responder -> do
                        oneWork
                            ...
                            [ PossessMedia
                                  100
                                  (foreignMedia Channel.MediaPhoto "photo 100") |>>
                              possessMediaSuccess Channel.MediaPhoto "photo 100"
                            , SendMedia
                                  100
                                  ""
                            ...
                            , PossessMedia
                                  100
                                  (foreignMedia Channel.MediaVideo "video 100") |>>
                              possessMediaSuccess Channel.MediaVideo "video 100"
                            , SendMedia
                                  100
                                  "caption 1"
                                  [ Channel.SendableMedia
                        ...
                        oneWork
                            ...
                            [ PossessMedia
                                  100
                                  (foreignMedia Channel.MediaAudio "audio 100") |>>
                              possessMediaSuccess Channel.MediaAudio "audio 100"
                            , PossessMedia
                                  100
                                  (foreignMedia
                                       Channel.MediaAnimation
                            ...
                            , PossessMedia
                                  ...
                                  (foreignMedia
                                       Channel.MediaUnknown
                                       "unknown 100") |>>
                              Channel.PossessMediaUnknownType "unknown b"
                            , PossessMedia
                                  100
                                  (foreignMedia Channel.MediaVoice "voice 100") |>>
                            ...
                            , PossessMedia
                                  ...
                                  (foreignMedia
                                       Channel.MediaUnknown
                                       "unknown 100 c") |>>
                              Channel.PossessMediaUnknownType "unknown a"
                            , PossessMedia
                                  100
                            ...
                            , SendMessage
                                  100
                                  (Channel.plainText
                                       (mediaUnknownTypeMsg "unknown a"))
                                  [] |>>
                              Right 11
                            , SendMessage
                                  100
                                  (Channel.plainText
                                       (mediaUnknownTypeMsg "unknown b"))
                                  [] |>>
                              Right 12
                            , SendMessage
                                  100
                                  (Channel.plainText mediaUnsupportedMsg)
                                  [] |>>
                              Right 13
                            , SendMessage
                                  100
                                  (Channel.plainText mediaInternalErrorMsg)
                                  [] |>>
                              Right 14
                            ]
